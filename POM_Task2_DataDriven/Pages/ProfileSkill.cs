...
namespace POM_Task2_DataDriven.Pages
{
    public class ProfileSkill
    {
        ...
        {
            Wait.ElementExists(driver, "XPath", "//div[contains(text(),'Badminton has been added to your skills')]", 40);
        ...
        {
            Wait.ElementExists(driver, "XPath", "//td[contains(text(),'Badminton')]", 30);
