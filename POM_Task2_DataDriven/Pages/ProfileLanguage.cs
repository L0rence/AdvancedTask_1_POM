...
namespace POM_Task2_DataDriven.Pages
{
    public class ProfileLanguage
    {
        ...
        */
        ...
        {
            Wait.ElementExists(driver, "XPath", "//div[contains(text(),'French has been added to your languages')]", 100);
        ...
        {
            Wait.ElementExists(driver, "XPath", "//td[contains(text(),'French')]", 30);
